...
(* CORE_GENERATION_INFO = "design_1,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=design_1,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=14,numReposBlks=14,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=1,numPkgbdBlks=0,bdsource=USER,da_axi4_cnt=2,da_bram_cntlr_cnt=1,da_clkrst_cnt=1,da_ps7_cnt=1,synth_mode=OOC_per_IP}" *) (* HW_HANDOFF = "design_1.hwdef" *) 
module design_1
   (DDR_addr,
    DDR_ba,
    DDR_cas_n,
  ...
  (* DEBUG = "true" *) (* MARK_DEBUG *) wire axi_reg_0_start;
  ...
  wire [8:0]sum_of_array_0_counter;
  wire sum_of_array_0_done;
  wire [31:0]sum_of_array_0_sum;
  ...
  design_1_axi_bram_ctrl_0_bram_0 axi_bram_ctrl_0_bram
       (.addra({1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,axi_bram_ctrl_0_BRAM_PORTA_ADDR}),
        .addrb({1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,xlconcat_0_dout}),
  ...
  design_1_axi_reg_0_0 axi_reg_0
       (.done(sum_of_array_0_done),
        ...
        .start(axi_reg_0_start),
        .sum(sum_of_array_0_sum));
  ...
  design_1_sum_of_array_0_0 sum_of_array_0
       (.clk(processing_system7_0_FCLK_CLK0),
        .counter(sum_of_array_0_counter),
  ...
  design_1_system_ila_0_0 system_ila_0
       (.clk(processing_system7_0_FCLK_CLK0),
        .probe0(axi_reg_0_start),
        .probe1(sum_of_array_0_done),
        .probe2(sum_of_array_0_sum),
        .probe3(xlconcat_0_dout),
        .probe4(axi_bram_ctrl_0_bram_doutb));
  design_1_util_vector_logic_0_0 util_vector_logic_0
       (.Op1(rst_ps7_0_100M_peripheral_aresetn),
        .Res(util_vector_logic_0_Res));
  design_1_xlconcat_0_0 xlconcat_0
       (.In0(xlconstant_0_dout),
        .In1(sum_of_array_0_counter),
